...
// Sonidos táctiles de hardware sintetizados en tiempo real mediante Web Audio API
const playTactileSound = (
  type: 'buttonA' | 'buttonB' | 'dpad' | 'start' | 'select' | 'toggle'
) => {
  ...
  try {
    ...
    // Si el navegador no permite audio o está bloqueado, no interrumpe la UI
  }
};
